...
namespace Task2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            FileStream fs = new FileStream(@"C:\Users\Багдан\Desktop\test\testINP\input.txt", FileMode.Open, FileAccess.Read);
            ...
            FileStream fs2 = new FileStream(@"C:\Users\Багдан\Desktop\test\Output.txt", FileMode.Create, FileAccess.Write);
