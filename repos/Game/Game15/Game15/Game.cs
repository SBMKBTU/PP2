...
namespace Game15
{
    class Game
    {
        ...
        {
            int x, y;
            position_to_coprds(position, out x, out y);
        ...
        {
            // shift(rand.Next(0, size * size));  ------Это неправельное решение , вместо этого используем эту:
            int a = rand.Next(0, 4);
            int x = space_x;
            int y = space_y;
            switch (a)
        ...
        private void position_to_coprds(int position , out int x , out int y)
        {
